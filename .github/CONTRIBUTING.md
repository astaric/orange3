...
At least include a method to reproduce (if consistently reproducible) and
...
* Only ever `import *` to bring make objects available in another namespace,
...
commits). The resulting example pull request should look clean:
    ...
    b432f18   Some feature I made
    85d5a0a   Some other bugfix
    439e303   Another new feature

[squash commits]: https://www.google.com/search?q=git+squash+commits
